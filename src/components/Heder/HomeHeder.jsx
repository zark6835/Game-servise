        ...
        <ul className="Heder__list">
          <li className="Heder__list-item">
            <div className="Heder__servises-list home">
              <p className={`body2 color-white ${servisesOpen ? 'open' : ''}`} onClick={openMenuServises}>SERVICES</p>
            </div>
          ...
          <li className="Heder__list-item">
            <div className="Heder__servises-list home">
            <p className={`body2 color-white ${technologiesOpen ? 'open' : ''}`} onClick={openMenuTechnologies}>TECHNOLOGIES</p>
            </div>
            <ul className={`Heder__servises-list-item-home ${technologiesOpen ? 'open' : ''}`}>
              <li><a className="body2 color-white" href="#">ANDROID</a></li>
              <li><a className="body2 color-white" href="#">IOS</a></li>
              <li><a className="body2 color-white" href="#">UNITY</a></li>
            </ul>
          </li>
          <li className="Heder__list-item">
          ...
          <li className="Heder__list-item">
          <div className="Heder__servises-list home">
            <p className={`body2 color-white ${aboutUsOpen ? 'open' : ''}`} onClick={openMenuAboutUs}>ABOUT US</p>
          </div>
          <ul className={`Heder__servises-list-item-home ${aboutUsOpen ? 'open' : ''}`}>
              <li><a className="body2 color-white" href="#">CONTACTS</a></li>
              <li><a className="body2 color-white" href="#">TEAM</a></li>
              <li><a className="body2 color-white" href="#">JOIN THE TEAM</a></li>
            </ul>
          </li>
        </ul>
